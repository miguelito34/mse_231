...
```{r}
ggsave(plot = all_tweets_plot, file = "all_tweets_plot.pdf", width = 2, height = 3)
```
...
```{r}
ggsave(plot = filtered_tweets_plot, file = "filtered_tweets_plot.pdf", width = 2, height = 3)
```
